"""
Server Handlers Package — 23 tools registered (v13 consolidation)
...
Tool inventory:
  ...
  11_PBIP_Authoring, 11_PBIP_Prototype, SVG_Visual_Operations
"""
...
def register_all_handlers(registry):
    ...
    register_prototype_handler(registry)           # 11_PBIP_Prototype
